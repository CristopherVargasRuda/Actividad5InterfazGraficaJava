...
public class LoginTemplate extends JFrame{
    ...
    private void crearJPanels(){  
        ...
        pSuperior = sObjGraficos.construirJPanel(
                0, 0, 1200, 140, 
                sRecursos.getColorFondo(), sRecursos.getBordeGris()
        );
        this.add(pSuperior);
    ...
    private void crearJPasswordFields(){
        ...
        tClaveUsuario = sObjGraficos.construirJPasswordField("Clave Usuario", 
                ...
                sRecursos.getColorGris(), sRecursos.getColorSpotify(), 
    ...
    private void crearJButtons(){ 
        ...
        //Botón Cerrar
        iDimAux = new ImageIcon(sRecursos.getiCerrar().getImage().getScaledInstance(12, 12, Image.SCALE_AREA_AVERAGING));
        bCerrar = sObjGraficos.construirJButton(
                null, 8, 7, 12, 12, sRecursos.getcMano(), iDimAux, null, null, 
                null, null, "c", false
        );
        ...
        //Botón Maximizar
        iDimAux = new ImageIcon(sRecursos.getiMaximizar().getImage().getScaledInstance(12, 12, Image.SCALE_AREA_AVERAGING));
        bMaximizar = sObjGraficos.construirJButton(
                null, 23, 7, 12, 12, sRecursos.getcMano(), iDimAux, null, null, 
                null, null, "c", false
        );
        pSuperior.add(bMaximizar);
        
        //Botón Minimizar
        iDimAux = new ImageIcon(sRecursos.getiMinimizar().getImage().getScaledInstance(12, 12, Image.SCALE_AREA_AVERAGING));
        bMinimizar = sObjGraficos.construirJButton(
                null, 38, 7, 12, 12, sRecursos.getcMano(), iDimAux, null, null, 
                null, null, "c", false
        );
